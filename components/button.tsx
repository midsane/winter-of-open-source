...
const StyledWrapper2 = styled.div`
  .button {
    ...
    border: 4px solid #c0dfff;   /* reduced border */
    color: white;
    gap: 6px;                    /* slightly reduced gap */
    border-radius: 40px;         /* scaled radius */
    cursor: pointer;
    transition: all 0.3s;
    transform: scale(0.85);      /* clean/global scale down */
  }
