  ...
  return (
    <div className="min-h-screen max-w-7xl mx-auto text-white p-6">
      ...
      <input
        ...
        className="w-full mb-6 px-4 py-2 rounded-lg bg-[#111] border border-gray-700"
      />
        ...
        {filteredUsers.map((u) => (
          <div key={u.uid} className="p-4 bg-[#111] rounded-xl border border-gray-700">
            ...
            <div className="mt-4 grid grid-cols-4 gap-3">
              {(["easy", "medium", "hard", "bonus"] as const).map((field) => (
                <div key={field}>
            ...
            <button
              ...
              className="mt-4 w-full py-2 bg-blue-600 hover:bg-blue-700 rounded-lg font-semibold disabled:opacity-50"
            >
              {savingMap[u.uid] ? "Saving…" : "Save Changes"}
            </button>
          </div>
        ))}
      </div>
